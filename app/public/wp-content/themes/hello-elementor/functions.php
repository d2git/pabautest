...
add_action('init', function() {
  if (isset($_POST['submit_lead'])) {
    $api_url = 'https://uk2.pabau.me/OAuth2/leads/lead-curl.php?api_key=MTUyMTc5c6555c14e129a73a29c7cfd29ecd593';
    $redirect_link = 'https://uk2.pabau.me/OAuth2/leads';
    ...
    if (is_wp_error($response)) {
      error_log('Lead API error: ' . $response->get_error_message());
    } else {
